...
def run_tracking_method(
    ...
    """
    run_tracking = repo_root / "Week3" / "tracking" / "main.py"
    ...
    try:
        ...
        tracking_outputs = repo_root / "Week3" / "tracking" / "outputs"
...
def run_evaluation(
    ...
    """
    evaluate_script = repo_root / "Week3" / "tracking" / "eval_tracking.py"
